...
$pasmo = $pole_pasmo[1] # [0]=PMR; [1]=LPD; [2]=UHF
...
echo "oprav radek cislo 20, zvoj jednu ze 3 moznosti"
echo "[0]=PMR; [1]=LPD; [2]=UHF"
echo "konec programu"
sleep 3
exit
}
...
echo 'pozn. soubor "csv" je samozdrejme upne obycejni textovy ascii soubor ktery ma misto pripony "txt" priponu "csv"'
echo "a lze si proto jeho obsah prohlednou v podstate jakemkoliv textovem editoru, pocinaje poznamkovym blokem ve Windows"
sleep 5
