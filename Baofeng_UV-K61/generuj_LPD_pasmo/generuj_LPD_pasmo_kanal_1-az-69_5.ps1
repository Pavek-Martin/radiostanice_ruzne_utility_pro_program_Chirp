...
<#
LPD pasmo 69 kanalu ( krok vzdy 0,025 )
...
############## zde edit zona ###################
$export_CSV_filename = "Baofeng_UK-K61_LPD_pasmo_kanal_1_az_69.csv"
...
$max_pametova_pozice_v_chirp = 69 # max. polozek v chirp
#
...
#                  [0]     [1]
$vykon = $pole_vykon[0] # [0]=1.0W; [1]=5.0W
#
$pole_skenovat = @( 0, 1 )
#                  [0] [1]
